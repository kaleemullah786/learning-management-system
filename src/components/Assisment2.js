  ...
  return (
    <div>
     ...
     <div class="border border-slate-300 w-[40%] p-2 ">
          <input type="checkbox" class="absolute right-[93%] top-[50%]" ></input>
          <button class="pl-6">HTML,CSS AND PHP</button>
          </div>
     </div>
       <div class="pb-4 text-left ">
       <div class="border border-slate-300 w-[40%] p-2"> 
           <input type="checkbox" class="absolute right-[93%] top-[58%]" ></input>
           <button class="pl-6">HTML,CSS AND SWIFT</button></div>
       </div>
      <div class="pb-4 text-left">
      <div class="border border-slate-300 w-[40%] p-2">
           <input type="checkbox" class="absolute right-[93%] top-[66%]" ></input>
