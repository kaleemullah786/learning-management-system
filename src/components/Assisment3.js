...
var Assisment3=()=> {
    return (
        <div>
            ...
            <hr />        <div class="absolute right-[94%] top-[45%]"><p class="text-[#C2C2C2] ">Results :</p></div>
            <div class="text-left p-20">
                ...
                <p class="flex p-2"><BsXCircleFill size={28} class="text-[#C81818]" />HTML,CSS and Javascript</p>
            ...
            <div>
                ...
                <div class="flex ml-[70%] gap-8 mt-[3%] mb-[3%]">
                    <button class=" text-[#717171] font-semibold ">I'll try it later</button>
                    <button class="bg-blue-500 hover:bg-[#31A4F5] text-white font-semibold py-1 px-9">Check Answer</button>
                </div>
